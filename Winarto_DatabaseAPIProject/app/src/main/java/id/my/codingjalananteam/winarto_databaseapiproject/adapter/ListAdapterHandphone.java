package id.my.codingjalananteam.winarto_databaseapiproject.adapter;
...
import id.my.codingjalananteam.winarto_databaseapiproject.R;
...
public class ListAdapterHandphone extends BaseAdapter implements
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_roww, null);
        }
